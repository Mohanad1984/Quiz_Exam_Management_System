...
namespace Quiz_Exam_Management_System
{
    public class DatenbankConnection
    {
        ...
        private const string SelectalleFrageAantworten_AnhandFrageId = "Select frageAntwort From FrageTbl Where frageId = ";
        ...
        private const string InsertIntoFrageTbl = "Insert Into FrageTbl (frageBeschreibung, frageWahl_1, frageWahl_2," +
                                                    " frageWahl_3, frageWahl_4, frageAntwort, fachId, admiId , EintragungsDatum)" + //frageWahl_5 EintragungsDatum ,admiId
                                                    " Values" +
                                                    " (@frageBeschreibung, @frageWahl_1, @frageWahl_2, @frageWahl_3, @frageWahl_4," +
                                                    " @frageAntwort, @fachId, @admiId, @EintragungsDatum )"; //, @frageWahl_5, @EintragungsDatum , @admiId 
        ...
        public string[] GetAntworten(string frage_id)
        {
            try
            {///sdsdsdsdsdsdsdddddddddddddd
                ...
                conn.Open();
                string s = SelectalleFrageAantworten_AnhandFrageId + "'" + frage_id + "'";
        ...
        public void FrageEintragen(string frageBeschreibung, string frageWahl_1, string frageWahl_2, string frageWahl_3, string frageWahl_4, string frageAntwort, int fachId) //frageWahl_5  int fBearbeitenAdmiId, DateTime fBearbeitendatum,, string fHinweise
        {
            try
            {
               ...
               // cmd.Parameters.AddWithValue("@frageId", frageId);
                ...
                cmd.Parameters.AddWithValue("@admiId", 1);
